...
public class WhatsappService {
    ...
    /**
     * Send a text message to a specific recipient, automatically selecting the appropriate instance
    ...
    /**
     * Send a media message to a specific recipient, automatically selecting the appropriate instance
     * @param to The recipient phone number or group ID
    ...
    public JsonNode getGlobalInstanceStatus() {
        ...
        JsonNode statusResponse = whatsappClient.getInstanceStatus(globalInstance.getToken(), globalInstance.getInstanceId());
    ...
    public void updateInstanceStatuses() {
        ...
        for (WhatsappInstance instance : instances) {
            try {
                ...
                log.error("Error updating status for instance {}: {